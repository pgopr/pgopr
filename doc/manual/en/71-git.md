...
In order to debug problems in your code you can use [lldb](https://lldb.llvm.org/) or [gdb](https://www.sourceware.org/gdb/). You can also add extra logging using the `tracing` ecosystem.
